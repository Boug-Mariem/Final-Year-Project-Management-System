...
public class Supprimer_etudiant extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Supprimer_etudiant frame = new Supprimer_etudiant();
	...
	public Supprimer_etudiant() {
        ...
        lblAfficherEtudiant.addMouseListener((MouseListener) new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Supprimer_etudiant.this.setVisible(false);
            }
        });
...
//TODO  ////////////////////////////////
        ...
        //////////////////////////////////////////
         ...
         scrollPane.setBounds(10, 205, 749, 293);
